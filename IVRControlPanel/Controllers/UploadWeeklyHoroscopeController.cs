...
{
    public class UploadWeeklyHoroscopeController : Controller
    {
        //
        // GET: /NewsUpload/
        ...
        public ActionResult Index(HoroscopeModel horoscopemodel)
        {
            ...
            if (ModelState.IsValid)
            {
                if (aries != null && aries.ContentLength > 0)
                {
                    ...
                    var path = Path.Combine(Server.MapPath("~/App_Data/uploads/Horoscope/weekly Horoscope/aries/"), fileName);
                    aries.SaveAs(path);
                ...
                if (taurus != null && taurus.ContentLength > 0)
                {
                    ...
                    var fileName = filenam.Replace(" ", "_");
                    var path = Path.Combine(Server.MapPath("~/App_Data/uploads/Horoscope/weekly Horoscope/taurus/"), fileName);
                    taurus.SaveAs(path);
                ...
                if (gemini != null && gemini.ContentLength > 0)
                {
                    ...
                    var path = Path.Combine(Server.MapPath("~/App_Data/uploads/Horoscope/weekly Horoscope/gemini/"), fileName);
                    gemini.SaveAs(path);
                ...
                if (cancer != null && cancer.ContentLength > 0)
                {
                    ...
                    var path = Path.Combine(Server.MapPath("~/App_Data/uploads/Horoscope/weekly Horoscope/cancer/"), fileName);
                    cancer.SaveAs(path);
                ...
                if (leo != null && leo.ContentLength > 0)
                {
                    ...
                    var path = Path.Combine(Server.MapPath("~/App_Data/uploads/Horoscope/weekly Horoscope/leo/"), fileName);
                    leo.SaveAs(path);
                ...
                if (virgo != null && virgo.ContentLength > 0)
                {
                    ...
                    var path = Path.Combine(Server.MapPath("~/App_Data/uploads/Horoscope/weekly Horoscope/virgo/"), fileName);
                    virgo.SaveAs(path);
                    var wav1 = new PlayWav
                    {
                        Name = fileName,
                ...
                if (libra != null && libra.ContentLength > 0)
                {
                    ...
                    var fileName = filenam.Replace(" ", "_");
                    var path = Path.Combine(Server.MapPath("~/App_Data/uploads/Horoscope/weekly Horoscope/libra/"), fileName);
                    libra.SaveAs(path);
                    var wav2 = new PlayWav
                    {
                        Name = fileName,
                ...
                if (scorpio != null && scorpio.ContentLength > 0)
                {
                    ...
                    var path = Path.Combine(Server.MapPath("~/App_Data/uploads/Horoscope/weekly Horoscope/scorpio/"), fileName);
                    scorpio.SaveAs(path);
                    var wav3 = new PlayWav
                    {
                        Name = fileName,
                ...
                if (sagittarius != null && sagittarius.ContentLength > 0)
                {
                    ...
                    var path = Path.Combine(Server.MapPath("~/App_Data/uploads/Horoscope/weekly Horoscope/sagittarius/"), fileName);
                ...
                if (capricorn != null && capricorn.ContentLength > 0)
                {
                    ...
                    var path = Path.Combine(Server.MapPath("~/App_Data/uploads/Horoscope/weekly Horoscope/capricorn/"), fileName);
                ...
                if (aquarius != null && aquarius.ContentLength > 0)
                {
                    ...
                    var path = Path.Combine(Server.MapPath("~/App_Data/uploads/Horoscope/weekly Horoscope/aquarius/"), fileName);
                ...
                if (pisces != null && pisces.ContentLength > 0)
                {
                    ...
                    var path = Path.Combine(Server.MapPath("~/App_Data/uploads/Horoscope/weekly Horoscope/pisces/"), fileName);
                    pisces.SaveAs(path);
